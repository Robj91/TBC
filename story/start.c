...
void main( void )
{
 ...
 load_sound("wscream.WAV", 50);
 load_sound("rumble.WAV", 51);
 load_sound("fall.WAV", 52);
 load_sound("metopen.WAV", 53);
 load_sound("muhaha.WAV", 54);
 load_sound("refill.WAV", 55);
 load_sound("fountain.WAV", 56);
 load_sound("drink.WAV", 57);
 load_sound("slayroar.WAV", 58);
 load_sound("charge.WAV", 59);
 load_sound("absorb.WAV", 60);
